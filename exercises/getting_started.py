...
print("content of D", D)            # [[50 50] [50 50] [50 50] [50 50] [50 50] [50 50]], shape=(6, 2), dtype=int32)

# Creating tensors from Exisiting Objects
tf_t = tf.convert_to_tensor(5.0, dtype=tf.float64)
print("tf.rank(tf_t): ", tf.rank(tf_t))  # tf.rank(tf_t):  tf.Tensor(0, shape=(), dtype=int32)
print("tf.shape(tf_t):", tf.shape(tf_t))  # tf.shape(tf_t): tf.Tensor([], shape=(0,), dtype=int32)
